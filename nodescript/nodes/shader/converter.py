...
class Blackbody(NodeBase):
    ...
    @property
    def inputs(self):
        return {"temperature": BType.VALUE}
...
class Clamp(NodeBase):
    ...
    @property
    def outputs(self):
        return {"result": BType.VALUE}

    @property
    def translation(self):
        return {"type": "clamp_type"}
...
class CombineHSV(NodeBase):
    ...
    @property
    def inputs(self):
        return {"h": BType.VALUE, "s": BType.VALUE, "v": BType.VALUE}
...
class CombineRGB(NodeBase):
    ...
    @property
    def inputs(self):
        return {"r": BType.VALUE, "g": BType.VALUE, "b": BType.VALUE}
...
class MapRange(NodeBase):
    ...
    @property
    def translation(self):
        return {"type": "interpolation_type"}
