...
class Brick(NodeBase):
    ...
    @property
    def outputs(self):
        return {"color": BType.COLOR, "fac": BType.VALUE}
...
class Gradient(NodeBase):
    ...
    @property
    def inputs(self):
        return {"type": BType.STRING, "vector": BType.VECTOR}
...
class IES(NodeBase):
    ...
    @property
    def inputs(self):
        return {"vector": BType.VECTOR, "strength": BType.VALUE}
...
class Musgrave(NodeBase):
    ...
    @property
    def outputs(self):
        return {"height": BType.VALUE}

    @property
    def translation(self):
        return {"dimensions": "musgrave_dimensions", "type": "musgrave_type"}
...
class Noise(NodeBase):
    ...
    @property
    def translation(self):
        return {"dimensions": "noise_dimensions"}
...
class Wave(NodeBase):
    ...
    @property
    def translation(self):
        return {"type": "wave_type", "profile": "wave_profile"}
...
class WhiteNoise(NodeBase):
    ...
    @property
    def inputs(self):
        return {"vector": BType.VECTOR, "w": BType.VALUE}
