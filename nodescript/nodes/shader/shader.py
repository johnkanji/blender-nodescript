...
class Add(NodeBase):
    ...
    @property
    def inputs(self):
        return {"shader1": BType.SHADER, "shader2": BType.SHADER}

    @property
    def outputs(self):
        return {"shader": BType.SHADER}
...
class Diffuse(NodeBase):
    ...
    @property
    def inputs(self):
        return {"color": BType.COLOR, "roughness": BType.VALUE, "normal": BType.VECTOR}
...
class Emission(NodeBase):
    ...
    @property
    def inputs(self):
        return {"color": BType.COLOR, "strength": BType.VALUE}
...
class Mix(NodeBase):
    ...
    @property
    def inputs(self):
        return {"fac": BType.VALUE, "shader1": BType.SHADER, "shader2": BType.SHADER}
...
class Translucent(NodeBase):
    ...
    @property
    def inputs(self):
        return {"color": BType.COLOR, "normal": BType.VECTOR}
...
class VolumeAbsorption(NodeBase):
    ...
    @property
    def inputs(self):
        return {"color": BType.COLOR, "density": BType.VALUE}
...
class VolumeScatter(NodeBase):
    ...
    @property
    def inputs(self):
        return {"color": BType.COLOR, "density": BType.VALUE, "anisotropy": BType.VALUE}
